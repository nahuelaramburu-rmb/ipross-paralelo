...
/**
 * BaseTokenServices is a copy of org.springframework.security.oauth2.provider.token.DefaultTokenServices
 * with custom @Transactional definitions
 * */
@Getter
public class BaseTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
     ...
     */
    OAuth2Authentication createRefreshedAuthentication(OAuth2Authentication authentication, TokenRequest request) {
