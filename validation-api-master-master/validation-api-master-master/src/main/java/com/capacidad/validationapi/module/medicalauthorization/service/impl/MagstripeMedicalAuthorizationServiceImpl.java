...
import com.capacidad.validationapi.module.medicalauthorization.service.MagstripeMedicalAuthorizationService;
...
@Log4j2
@Service
public class MagstripeMedicalAuthorizationServiceImpl extends BaseMedicalAuthorizationServiceImpl<MedicalAuthorization, MagstripeMedicalAuthorizationDTO> implements MagstripeMedicalAuthorizationService {

    private final BeneficiaryFinder beneficiaryFinder;

    @Autowired
    public MagstripeMedicalAuthorizationServiceImpl(MedicalAuthorizationRepository repository,
    ...
    @Override
    public MedicalAuthorization initialize(MagstripeMedicalAuthorizationDTO medicalAuthorizationDTO) throws ObjectNotValidException, ObjectNotFoundException {
        ...
        initializedInput.setBeneficiary(beneficiaryFinder.findBeneficiaryLocked(mappedBeneficiary.getBeneficiaryCode()));
        this.validate(initializedInput);
        initializedInput.setAuthorizationType(AuthorizationTypeReference.AUTHORIZATION_TYPE_MANUAL_MAGSTRIPE.getInstance());
