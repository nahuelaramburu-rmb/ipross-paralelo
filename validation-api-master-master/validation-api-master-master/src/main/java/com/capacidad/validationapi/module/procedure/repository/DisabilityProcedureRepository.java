...
@Repository
@TenantFilter
public interface DisabilityProcedureRepository extends BaseProcedureRepository<DisabilityProcedure> {

    @Override
    @Query(value = "select case when count(p)> 0 then true else false end from DisabilityProcedure p " +
