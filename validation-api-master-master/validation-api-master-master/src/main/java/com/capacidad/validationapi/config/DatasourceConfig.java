...
import com.capacidad.validationapi.module.base.repository.JpaSpecificationExecutorWithProjectionImpl;
...
@EnableJpaRepositories(
        ...
        basePackages = "com.capacidad.validationapi.module")
public class DatasourceConfig {
    ...
    protected static HikariConfig buildHikariConfig(Map<String, Object> dataSourceProperties) {
        ...
        config.setJdbcUrl(dataSourceProperties.get("jdbcUrl").toString());
    ...
    @Bean
    public DataSourceHealthIndicator primaryDataSourceHealthIndicator(DataSource dataSource) {
    ...
    entityManagerFactory(
        ...
        return builder
                ...
                .packages("com.capacidad.validationapi.module")
    ...
    public ChainedTransactionManager transactionManager(@Qualifier("transactionManager") PlatformTransactionManager primaryDatasourceTransactionManager,
                                                        @Qualifier("galbopTransactionManager") PlatformTransactionManager galbopDatasourceTransactionManager) {
        return new ChainedTransactionManager(primaryDatasourceTransactionManager, galbopDatasourceTransactionManager);
    }
