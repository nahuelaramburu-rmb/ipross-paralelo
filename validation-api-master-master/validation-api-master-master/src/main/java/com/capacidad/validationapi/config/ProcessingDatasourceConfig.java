...
@EnableJpaRepositories(
        entityManagerFactoryRef = "processingEntityManagerFactory",
...
public class ProcessingDatasourceConfig {
    ...
    public DataSource processingDataSource(@Qualifier("dataSourceProperties") Map<String, Object> dataSourcePropertiesHolder) {
        ...
        HikariConfig config = DatasourceConfig.buildHikariConfig(dataSourceProperties);
    ...
    processingEntityManagerFactory(
    ...
    public PlatformTransactionManager transactionManager(
            @Qualifier("processingEntityManagerFactory") EntityManagerFactory processingEntityManagerFactory) {
