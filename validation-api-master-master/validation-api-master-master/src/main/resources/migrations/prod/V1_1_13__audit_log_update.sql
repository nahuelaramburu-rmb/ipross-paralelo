...
update failure set name = 'No es posible transaccionar mas de 1 validaciones entre un mismo afiliado y un mismo prestador para la presente práctica'
where name like 'Solo una practica (Aprobada y/o Pendiente de Aprobacion) por transaccion, entre un mismo Beneficiario y Prestador, dentro de un periodo determinado de dias';
update failure set name = 'La cobertura del afiliado establece un límite de edad para la práctica entre 0 - 1 años'
where name like 'validateAge';