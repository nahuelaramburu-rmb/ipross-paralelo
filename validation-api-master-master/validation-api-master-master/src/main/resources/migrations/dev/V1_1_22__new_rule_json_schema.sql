...
update rule set name = 'Practica unica APROBADA por transaccion que puede realizar un Beneficiario con un mismo Prestador dentro de un periodo determinado de dias', dto_class_name = 'com.capacidad.validationapi.module.ruleprocessor.dto.DayOnlyDTO' where id = 2;
...
values  (1, 'maxAmount', 'maxAmount', 'integer', 'Cantidad Maxima', null, 'RAW_VALUE', null, true, 1),
        ...
        (4, 'nomenclators', 'id', 'array', 'Nomenclatores a excluir', 'name', 'NOMENCLATOR', null, false, 3),
        (5, 'maxAmount', 'maxAmount', 'integer', 'Edad limite', null, 'RAW_VALUE', null, true, 3),
        (6, 'timedNomenclators', 'id', 'object', 'Nomenclator', 'name', 'NOMENCLATOR', 'nomenclator', true, 4),
