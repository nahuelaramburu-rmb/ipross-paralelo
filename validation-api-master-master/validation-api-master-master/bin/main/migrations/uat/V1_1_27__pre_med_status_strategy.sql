...
alter table if exists pre_medical_authorization add column cancellation_reason varchar(255);
alter table if exists pre_medical_authorization_audit_log add column cancellation_reason varchar(255);
alter table if exists pre_medical_authorization_audit_log add column cancellation_reason_mod boolean;