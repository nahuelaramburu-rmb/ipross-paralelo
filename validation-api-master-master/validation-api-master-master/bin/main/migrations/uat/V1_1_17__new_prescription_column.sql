...
delete from qrtz_cron_triggers where trigger_name in ('PrescriptionUtilizedStatusSync', 'PrescriptionExpiredStatusSync');
delete from qrtz_triggers where job_name in ('PrescriptionUtilizedStatusSync', 'PrescriptionExpiredStatusSync');
delete from qrtz_job_details where job_name in ('PrescriptionUtilizedStatusSync', 'PrescriptionExpiredStatusSync');
