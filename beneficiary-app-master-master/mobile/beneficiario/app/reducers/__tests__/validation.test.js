...
describe('validation reducer tests', () => {
    ...
    it('should handle FETCH_VALIDATIONS_SUCCESS with refresh false', () => {
        const fetchValidationsSuccessAction = {
            ...
            validations: { _links: { link1: { href: 'test.com' } }, _embedded: [{ id: 1, date: '10/10/2010' }, { id: 2, date: '14/10/2010' }] },
            isRefresh: false
        };
    ...
    it('should handle FETCH_MORE_VALIDATION_SUCCESS', () => {
        const fetchMoreValidationsSuccessAction = {
            ...
            validations: { _links: { next: { href: 'capacidad.com?page=2&size=50' } }, _embedded: { authorizations: [{ id: 3, date: '20/10/10' }] } }
        };
        ...
        const preloadInitialState = {
            ...
            validations: {
                ...
                _embedded: {
                    authorizations: [{ id: 1, date: '10/10/2010' }, { id: 2, date: '14/10/2010' }]
                }
            }
        };
        ...
        const expectedState = {
            ...
            validations: {
                ...
                _embedded: {
                    authorizations: [{ id: 1, date: '10/10/2010' }, { id: 2, date: '14/10/2010' }, { id: 3, date: '20/10/10' }]
                }
            },
            loadingMore: false,
            status: null
