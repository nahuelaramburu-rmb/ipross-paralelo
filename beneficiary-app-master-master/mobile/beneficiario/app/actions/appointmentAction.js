...
export const registerApplicant = () => (dispatch, getState) =>
    _registerApplicant( dispatch, getState);
const _registerApplicant = async ( dispatch, getState) => {
    ...
    try {
        const response = await fetch(
            apiUrls['api-turnos'] + `/apiv1/applicants`,
            {
                method: 'POST',
                headers: {
                    Accept: 'application/json',
...
export const getAppointments = (isRefresh = false) => (dispatch, getState) =>
...
const _getAppointments = async (isRefresh = false, dispatch, getState) => {
    ...
    try {
        const response = await fetch(
            encodeURI(
                apiUrls['api-turnos'] +`/apiv1/applicants/${id}/turns?page=1&per_page=5&sort_by=fecha&sort_type=desc`,
        ...
        dispatch({ type: FETCH_APPOINTMENTS_SUCCESS, 
                    appointments: json,
                 });
...
const _getAppointmentById = async ( appointmentId , dispatch, getState) => {
    ...
    try {
        const response = await fetch(
            encodeURI(
                apiUrls['api-turnos'] +`/apiv1/turns/search?turn_id=${appointmentId}`,
            ),
            {
                method: 'GET',
                headers: {
        ...
        dispatch({ type: FETCH_APPOINTMENT_BY_ID_SUCCESS, 
                   appointments: json, 
        });
...
const _getDelegations = async ( isRefresh,dispatch, getState) => {
    ...
    try {
        const response = await fetch(
            encodeURI(
                apiUrls['api-turnos'] +`/apiv1/delegations`
            ),
            {
                method: 'GET',
                headers: {
        ...
        dispatch({ type: FETCH_DELEGATIONS_SUCCESS, 
            delegations: json,
            isRefresh: isRefresh,
         });
...
const _getAppointmentEnabled = async (delegationId,sectorId, dispatch, getState) => {
    ...
    try {
        ...
        dispatch({ type: FETCH_APPOINTMENTS_ENABLED_SUCCESS, 
                   turnos: json,
        });
...
const _createAppointment = async (data, dispatch, getState) => {
    ...
    try {
        const response = await fetch(
            apiUrls['api-turnos'] + `/apiv1/turns`,
            {
                method: 'POST',
                headers: {
                    Accept: 'application/json',
...
export const confirmAppointment = () => (dispatch, getState) =>
    _confirmAppointment(dispatch, getState);
...
const _confirmAppointment = async (dispatch, getState) => {
    ...
    try {
        const response = await fetch(
            apiUrls['api-turnos'] + `/apiv1/turns/confirm`,
            {
                method: 'POST',
                headers: {
                    Accept: 'application/json',
...
const _cancelAppointment = async (token_turno,dispatch, getState) => {
    ...
    try {
        const response = await fetch(
            apiUrls['api-turnos'] + `/apiv1/turns/cancel`,
            {
                method: 'POST',
                headers: {
                    Accept: 'application/json',
