...
const ProfessionalForm = ({
    ...
    const { typesSpecialty, specialties, specialtiesLoading, typesSpecialtyLoading, towns, townsLoading } =
        useSelector(
            (state) => ({
        ...
        <View style={styles.container}>
            <View style={styles.inputContainer}>
                <DropdownOther
                    ...
                    {!!typesSpecialty &&
                        typesSpecialty.map((it) => <Option key={it.id} id={it.id}>{`${it.name}`}</Option>)}
                </DropdownOther>
            </View>
            {/* Especialidad */}
            <View style={styles.inputContainer}>
                <DropdownOther
                    ...
                    {specialties.map((it) => (
                        <Option key={it.id} id={it.id}>{`${it.name}`}</Option>
                    ))}
                </DropdownOther>
            </View>
            ...
            <View style={styles.inputContainer}>
                <DropdownOther
                    ...
                    rightIcon={
                        townsLoading ? <ActivityIndicator size='small' color={Colors.primaryText} /> : null
                    }
