        ...
        <View style={styles.container}>
            <View style={styles.inputContainer}>
                <Dropdown
                    ...
                    {delegations.map((it) => (
                        <Option key={it.id} id={it.id}>{`${it.nombre}`}</Option>
                    ))}
                </Dropdown>
            </View>
            <View style={styles.inputContainer}>
                <Dropdown
                    ...
                    disabled={disabled}
                    rightIcon={
                        sectorsLoading ? <ActivityIndicator size='small' color={Colors.primaryText} /> : null
                    }
            ...
            <View style={styles.inputContainer}>
                <Dropdown
                    ...
                    disabled={disabled}
                    rightIcon={
                        turnosLoading ? <ActivityIndicator size='small' color={Colors.primaryText} /> : null
                    }
