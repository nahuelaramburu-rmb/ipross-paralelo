...
const BottomSvg = ({ style }) => {
    return (
        <Svg
            ...
            style={style}
            viewBox='0 0 79.441 38.12'
            enable-background='new 0 0 79.441 38.12'
                ...
                <G opacity='0.1' clip-path='url(#SVGID_2_)'>
                    <G>
                        ...
                        <Path
                            ...
                            fill='#AAA79D'
                            d='M31.345,28.562l0.002,0.005c-5.817-2.409-12.553-2.6-18.828,0.003 c-12.55,5.2-18.507,19.589-13.305,32.138c5.201,12.549,19.589,18.507,32.138,13.305c2.484-1.029,4.485-2.652,6.417-4.316 l3.988-4.609c0.85-1.225,1.839-2.355,2.452-3.707l19.389-46.186C56.921,31.323,47.474,35.238,31.345,28.562'
                        />
