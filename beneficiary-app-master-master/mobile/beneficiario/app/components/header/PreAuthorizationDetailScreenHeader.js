...
const PreAuthorizationDetailScreenHeader = ({ pop }) => {
    ...
    return (
        <HeaderWrapper style={[styles.shadow, { top: insets.top }]}>
            <TopNavigationButton
                ...
                action={pop}
            />
            <TopNavigationTitle title={strings.header.preAuthorizationDetail} />
        </HeaderWrapper>
    );
};
...
export default React.memo(PreAuthorizationDetailScreenHeader);
