...
const AuthorizationRatingScreenHeader = ({ pop }) => {
    ...
    return (
        <HeaderWrapper style={[styles.shadow, { top: insets.top }]}>
            ...
            />
            {rightOperation}
            <TopNavigationTitle title={strings.header.rating_title} />
        </HeaderWrapper>
    );
};
...
export default React.memo(AuthorizationRatingScreenHeader);
