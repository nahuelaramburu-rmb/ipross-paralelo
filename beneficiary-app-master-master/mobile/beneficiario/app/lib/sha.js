...
(function (E) {
    function t(c, a, e) {
        ...
        v = e.numRounds || 1;
        l = y(a, f);
        if (v !== parseInt(v, 10) || v < 1) throw Error('numRounds must a integer >= 1');
        if (c === 'SHA-1') (m = 512), (w = z), (n = F), (h = 160);
    ...
    function G(c, a, e) {
        ...
        e = e || 0;
        l = e >>> 3;
        if (g % 2 !== 0) throw Error('String of HEX type must be in byte increments');
        for (b = 0; b < g; b += 2) {
    ...
    function I(c, a, e) {
        ...
        e = e || 0;
        a = e >>> 3;
        if (c.search(/^[a-zA-Z0-9=+\/]+$/) === -1) throw Error('Invalid character in base-64 string');
        f = c.indexOf('=');
        c = c.replace(/\=/g, '');
        if (f !== -1 && f < c.length) throw Error("Invalid '=' found in base-64 string");
    ...
    function B(c, a) {
        ...
        for (b = 0; b < g; b += 1)
            (d = c[b >>> 2] >>> (8 * (3 - (b % 4)))),
                (e += '0123456789abcdef'.charAt((d >>> 4) & 15) + '0123456789abcdef'.charAt(d & 15));
    ...
    function A(c) {
        ...
        a.b64Pad = c.b64Pad || '=';
        if (typeof a.outputUpper !== 'boolean') throw Error('Invalid outputUpper formatting option');
        if (typeof a.b64Pad !== 'string') throw Error('Invalid b64Pad formatting option');
        return a;
    }
    function y(c, a) {
        var e;
                            ...
                            for (
                                d = e.charCodeAt(h),
                                    ...
                                    d < 128
                                        ...
                                        : d < 55296 || d >= 57344
                                        ? c.push(224 | (d >>> 12), 128 | ((d >>> 6) & 63), 128 | (d & 63))
                                        : ((h += 1),
    ...
    function u(c, a, e, g, b) {
        ...
        return (
            ((((c >>> 16) + (a >>> 16) + (e >>> 16) + (g >>> 16) + (b >>> 16) + (d >>> 16)) & 65535) << 16) |
            (d & 65535)
        );
    }
    function x(c) {
        if (c === 'SHA-1') c = [1732584193, 4023233417, 2562383102, 271733878, 3285377520];
    ...
    function z(c, a) {
        ...
        k = a[4];
        for (h = 0; h < 80; h += 1)
            (e[h] = h < 16 ? c[h] : r(e[h - 3] ^ e[h - 8] ^ e[h - 14] ^ e[h - 16], 1)),
                (l =
                    h < 20
