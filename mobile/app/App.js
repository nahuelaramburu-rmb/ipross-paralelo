...
class App extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            loggedUser: null,
            showPassword: false,
            currentScreen: 'login', // 'login', 'register', 'forgotPassword'
        };
    }
    ...
    handleLogin = async () => {
        ...
        if (currentScreen === 'register') {
            return <RegisterScreen onBack={() => this.setState({ currentScreen: 'login' })} />;
        }

        // Mostrar pantalla de recuperación de contraseña
        if (currentScreen === 'forgotPassword') {
            return <ForgotPasswordScreen onBack={() => this.setState({ currentScreen: 'login' })} />;
        }
