...
const PreAuthorizationScreenHeader = ({ pop }) => {
    const insets = useSafeAreaInsets();
    const route = useRoute();

    const animatedValueHeight = route.params?.animatedValueHeight ?? null;
    const animatedValueOpacity = route.params?.animatedValueOpacity ?? null;
    ...
    return (
        <HeaderWrapper
            ...
            <TopNavigationTitle title={strings.header.preAuthorizations} />
            <TopNavigationButton
...
export default React.memo(PreAuthorizationScreenHeader);
